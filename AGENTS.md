...
- `mvn test` runs all JUnit 4 tests across modules. `mvn test -Dtest='!*IntegrationTest'` runs the non-Docker suite (355 tests as of 2026-07-06: durga-runtime 215, durga-tools 63, durga-monitor 77); integration tests require Docker and are suffixed `IntegrationTest`.
