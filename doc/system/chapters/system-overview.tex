...
\begin{figure}[!ht]
    ...
    \begin{tikzpicture}[node distance=16mm,>=latex]
        ...
        \node[box, right=22mm of scaffolder] (generated) {Generated process\\project (fat jar)};
        ...
        \node[accentbox, above=8mm of monitoring] (models) {process-models\\(BPMN registry)};

        \draw[->, thick] (bpmn) -- (scaffolder);
        \draw[->, thick] (scaffolder) -- (generated);
        \draw[->, thick] (generated) -- (topics);
        \draw[->, thick] (generated) -- (events);
        \draw[->, thick] (generated) -- (models) node[midway, above, sloped, font=\footnotesize] {auto-registers on boot};
