...
redirected to \texttt{-validation} topics, lifecycle events go to the per-process
\texttt{process-events-\%processId\%-validation} topic, and \texttt{application.yml} plus the topic-creation
...
\texttt{vannak-metadata-events-\{processId\}} Kafka topic. This keeps Durga's lifecycle
...
\item Build the generated project, run a starter or scenario, and observe progress
  through \texttt{process-events-\{processId\}}, \texttt{vannak-metadata-events-\{processId\}}, and the
  monitoring views.
