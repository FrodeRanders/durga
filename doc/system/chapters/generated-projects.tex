...
The BPMN model copy travels with the project and serves as the source of truth for
regeneration. During the build, the \texttt{ModelEnricher} utility updates it with
implementation metadata for custom activities, so the model always reflects the
