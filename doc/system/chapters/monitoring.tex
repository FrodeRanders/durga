...
The fault detection topology maintains three persistent state stores:
...
Unit tests are in \texttt{FaultDetectionTest}, \texttt{AlarmStateViewTest}, and
\texttt{AlarmStateTopologyTest}; see
