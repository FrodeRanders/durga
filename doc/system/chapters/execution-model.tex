...
Boundary timer, error and escalation handlers are generated from BPMN boundary events and consume the canonical lifecycle stream on \texttt{process-events-monitor}. The current boundary implementation supports:
\begin{itemize}
