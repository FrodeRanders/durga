...
partition state are maintained per route. A version-3 profile is serialized as
...
establishes provenance. Generated descriptors select maxima of 32 broker
endpoints and 64 produce routes; operators may lower those admission ceilings,
while Charlotte rejects declared or actual counts above its hard maxima. The missing
