...
partition state are maintained per route. A version-5 profile is serialized as
...
credentials. The version-5 profile publishes a separately named transactional
