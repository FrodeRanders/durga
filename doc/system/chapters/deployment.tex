...
concurrency up to the partition count of the input topic. Three mechanisms
are available, from simple to sophisticated.
...
Suitable for development and staging. The operator watches consumer lag
(via Kafka UI or CLI) and adjusts replicas.
